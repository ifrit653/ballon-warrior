...
# Joyous color palettes
var joyous_colors = [
	Color(1.0, 0.9, 0.0, 1.0),    # Sunny Yellow
	Color(1.0, 0.5, 0.0, 1.0),    # Vibrant Orange  
	Color(1.0, 0.0, 0.5, 1.0),    # Hot Pink
	Color(0.0, 0.8, 1.0, 1.0),    # Electric Blue
	...
	Color(0.7, 0.0, 1.0, 1.0),    # Purple
]

func get_joyous_color() -> Color:
	return joyous_colors[randi() % joyous_colors.size()]

func _ready():
	# Set joyous color modulation
	modulate = get_joyous_color()
